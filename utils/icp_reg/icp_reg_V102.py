...
source.rotate(get_rot_mat('x', math.pi + math.pi/16), source.get_center())
source.rotate(get_rot_mat('y', -math.pi/16), source.get_center())
source.rotate(get_rot_mat('z', -math.pi/8), source.get_center())
...
source.scale(1.5, source.get_center())
